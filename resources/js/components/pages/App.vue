        ...
        <div class="row">
            <div class="col-md-auto col-12">
                <ul class="nav flex-column nav-pills" id="pills-tab" role="tablist">
                    <li v-if="user.twitter_profiles.length > 0" class="nav-item">
                        <a :class="{'active': user.twitter_profiles.length > 0}" class="nav-link" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
            ...
            <div class="col-md col-12">
                <div class="tab-content" id="pills-tabContent" :class="{'no-profiles': user.twitter_profiles.length == 0}">
                    <div v-if="user.twitter_profiles.length > 0" class="tab-pane show" :class="{'active': user.twitter_profiles.length > 0}" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
