        ...
        <div class="row no-gutters app-wrapper">
            <aside id="sidebar" class="col-md-auto col-12">
                <ul class="nav flex-column nav-pills" id="pills-tab" role="tablist">
                    <li v-if="user.synced_profiles != null" class="nav-item">
                        <a :class="{'active': user.synced_profiles != null}" class="nav-link" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
                    ...
                    <li class="nav-item">
                        <a :class="{'active': user.synced_profiles.length == 0}" class="nav-link" id="pills-profiles-tab" data-toggle="pill" href="#pills-profiles" role="tab" aria-controls="pills-profiles" aria-selected="false">
            ...
            <div class="col-md col-12">
                <div class="tab-content" id="pills-tabContent" :class="{'no-profiles': user.synced_profiles.length == 0}">
                    <div v-if="user.synced_profiles != null" class="tab-pane show" :class="{'active': user.synced_profiles != null}" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <dashboard :user="user" :timeline="timeline" :mentions="mentions" :chats="chats" :lists="lists" :loadtime="loadtime"></dashboard>
                    </div>
                    <div v-if="user.synced_profiles != null" class="tab-pane" id="pills-stats" role="tabpanel" aria-labelledby="pills-stats-tab">
                    ...
                    <div class="tab-pane" :class="{'active': user.synced_profiles.length == 0}" id="pills-profiles" role="tabpanel" aria-labelledby="pills-profiles-tab">
