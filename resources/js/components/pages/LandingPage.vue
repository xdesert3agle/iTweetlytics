<template>
    <div class="landing-content">
        ...
        <div class="section" id="signup">
            <div class="container">
                <div class="section-title text-center">
                    <h3>Comienza ya tu periodo de prueba</h3>
                    <p>Únete ahora. Es completamente gratuito y toma menos de 3 minutos.</p>
                </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group">
                                        <input id="name" type="text" class="form-control" name="name" placeholder="Nombre" required autocomplete="name">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <input id="surname" type="text" class="form-control" name="surname" placeholder="Apellidos" required autocomplete="surname">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <input id="email" type="email" class="form-control" name="email" placeholder="Dirección de correo electrónico" required autocomplete="email">
                            </div>
                            <div class="form-group">
                                <input id="password" type="password" class="form-control" name="password" placeholder="Contraseña" required autocomplete="new-password">
                            </div>
                            <div class="form-group">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Confirmar contraseña" required autocomplete="new-password">
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-xl btn-block btn-primary">Comenzar el periodo de prueba</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="section bg-light mt-4" id="footer">
            <div class="container">
                ...
                <div class=" text-center mt-4">
                    <small class="text-muted">Copyright © {{ currentYear }} All rights reserved. iTweetlytics.</small>
                </div>
            </div>
            <!-- // end .container -->
        </div>
