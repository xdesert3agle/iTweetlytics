        ...
        <div class="col-12 profile-stats-container">
            <div class="row no-gutters card-row">
                <div class="col-md-4 col-12">
                    <graph-card id="followers" :user="user" :stat_endpoint="'/ajax/profile/' + user.current_twitter_profile[0].id + '/reports/followers/'" card_title="Seguidores" modal_title="Seguidores">
                            ...
                            <ul class="profiles-list">
                                <li v-for="(follower, i) in user.current_twitter_profile[0].followers" :id="'element-' + follower.screen_name">
                                    <div class="row profile-link">
                                        ...
                                        <div v-if="user.current_twitter_profile[0].friends[follower.id_str]" class="col-4">
                ...
                <div class="col-md-4 col-12">
                    <graph-card id="follows" :user="user" :stat_endpoint="'/ajax/profile/' + user.current_twitter_profile[0].id + '/reports/follows/'" card_title="Nuevos seguidores" modal_title="Nuevos seguidores">
                        <template slot="modal-trigger">
                            <button class="btn-text">Detalles</button>
                        </template>
                    </graph-card>
                ...
                <div class="col-md-4 col-12">
                    <graph-card id="unfollows" :user="user" :stat_endpoint="'/ajax/profile/' + user.current_twitter_profile[0].id + '/reports/unfollows/'" card_title="Unfollowers" modal_title="Unfollowers">
                        <template slot="modal-trigger">
                            <button class="btn-text">Detalles</button>
                        </template>
                    </graph-card>
