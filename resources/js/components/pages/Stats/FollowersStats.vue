        ...
        <div class="col-12 profile-stats-container">
            <div class="row no-gutters card-row">
                <div class="col-md-4 col-12">
                    <graph-card id="followers" :user="user" :stat_endpoint="'/ajax/profile/' + user.current_synced_profile.id + '/stats/followers/'" card_title="Seguidores" modal_title="Seguidores">
                ...
                <div class="col-md-4 col-12">
                    <graph-card id="follows" :user="user" :stat_endpoint="'/ajax/profile/' + user.current_synced_profile.id + '/stats/follows/'" card_title="Nuevos seguidores" modal_title="Nuevos seguidores">
                        <template slot="modal-trigger">
                            <button class="btn-text">Detalles</button>
                        </template>
                    </graph-card>
                ...
                <div class="col-md-4 col-12">
                    <graph-card id="unfollows" :user="user" :stat_endpoint="'/ajax/profile/' + user.current_synced_profile.id + '/stats/unfollows/'" card_title="Unfollowers" modal_title="Unfollowers">
                        <template slot="modal-trigger">
                            <button class="btn-text">Detalles</button>
                        </template>
                    </graph-card>
