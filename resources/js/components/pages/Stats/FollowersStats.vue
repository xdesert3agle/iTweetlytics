                    ...
                    <graph-card id="followers" :user="user" :stat_endpoint="'/ajax/profile/' + user.current_user_profile.id + '/stats/followers/'" card_title="Seguidores" modal_title="Seguidores">
                        ...
                        <template slot="modal">
                            <ul class="profiles-list">
                                <li v-for="(follower, i) in user.current_user_profile.followers" :id="'element-' + follower.screen_name">
                                    <div class="row profile-link">
                                        ...
                                        <div v-if="user.current_user_profile.friends[follower.id_str]" class="col-4">
